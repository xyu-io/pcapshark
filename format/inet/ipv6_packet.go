	...
	if isIpv6Option(nextHeader) {
		...
		d.FieldArray("extensions", func(d *decode.D) {
			for isIpv6Option(nextHeader) {
				//todo stdout->yaml d.FieldStruct("extension", func(d *decode.D) {
				d.FieldStruct("", func(d *decode.D) {
					d.FieldValueStr("type_name", "extension")
					...
					d.FramedFn(int64(extLen)*8, func(d *decode.D) {
						...
						case nextHeaderHopByHop:
							d.FieldArray("options", func(d *decode.D) {
								for !d.End() {
									//todo stdout->yaml d.FieldStruct("option", func(d *decode.D) {
									d.FieldStruct("", func(d *decode.D) {
										d.FieldValueStr("type_name", "option")
