...
import (
	...
	"github.com/xyu-io/pcapshark/internal/recoverfn"
...
func decode(ctx context.Context, br bitio.ReaderAtSeeker, group *Group, opts Options) (*Value, any, error) {
	...
	if opts.ParseOptsFn != nil && groupArg != nil { // nil
	...
	for _, f := range group.Formats {
		...
		if opts.InArg != nil { // todo not nil
			inArgs = append(inArgs, opts.InArg)
		}
		if !hasFormatOpts && f.DefaultInArg != nil { // nil
